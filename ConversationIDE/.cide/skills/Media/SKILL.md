...
| Audio, speech, music, transcription, TTS, voice cloning | `MasterSkills/AudioSkill.md` |
| Image, photo, face detection, OCR, segmentation, effects | `MasterSkills/ImageSkill.md` |
| Video, face detection, trim, GIF, download, effects | `MasterSkills/VideoSkill.md` |
| PRD, catalog, scan PRDs, artifacts, timeline | `MasterSkills/PRDSkill.md` |
